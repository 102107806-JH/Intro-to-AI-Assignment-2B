...
class AdjacencyListGraph:
    def __init__(self):
        ...
        self._scats_to_index = {} # Stores the current scats number as the key and the index within the adjacency list as the value

    def insert_vertex(self, scats_number, long, lat):  # Insert another vertex into adjacency list #
        self._scats_to_index[scats_number] = len(self._adjacency_list)  # Length of the list before appending is the index of the incoming scats number vertex in the list #
    ...
    def insert_edge_into_vertex(self, origin_scats_number, destination_scats_number):  # Insert another edge for the origin scats number #
        ...
        origin_vertex.add_edge(DestinationDistancePair(destination_scats_number, distance))  # Destination distance pair constructor #
    ...
    def scats_number_to_vertex(self, scats_number):
        vertex_idx = self._scats_to_index.get(scats_number, None)
